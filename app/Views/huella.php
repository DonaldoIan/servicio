...
<head>
  ...
  <link rel="stylesheet" href="<?=base_url('/public/img/css');?>/style1.css">
  <link rel="stylesheet" href="https://use.typekit.net/yhi3tir.css">
...
<section class="main d-flex-center">
        <div class="container d-flex-center">
            <div class="horas d-flex-center">
                <p class="margin-right" id="horaReloj"></p>
            </div>
            <div class="minutos d-flex-center">
                <p class="margin-right" id="minutoReloj"></p>
            </div>
            <div class="segundo d-flex-center">
                <p class="margin-right" id="segundoReloj"></p>
            </div>
            <div class="meridiano d-flex-center">
                <p class="margin-right" id="meridianoReloj"></p>
            </div>
        </div>
    ...
    <section data-bs-version="5.1" class="features16 cid-tJF0PyWSOB" id="features17-a">

<div class="col-12 col-lg">
    <div class="text-wrapper text-center">
        <h6 class="card-title mbr-fonts-style display-1 text-dark">
            <strong>Bienvenid@</strong><strong><br></strong></h6>
        <p class="mbr-text mbr-fonts-style mb-4 display-5 text-dark">Por favor, coloca tu huella dactilar en el sensor para registrar tu asistencia. <br>
          Una vez que se haya registrado con éxito, da clic en el botón de finalizar.</p>

        <div class="mbr-section-btn mt-3">
            <a class="btn btn-success display-4" href="">
                <span class="mobi-mbri mobi-mbri-success mbr-iconfont mbr-iconfont-btn"></span>Finalizar
            </a>
        </div>
    </div>
</div>
    ...
    <script src="<?=base_url('/public/img/js');?>/main1.js"></script>
