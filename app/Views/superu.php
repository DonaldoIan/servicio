    ...
    <div class="align-center container-fluid">
        <div class="row justify-content-center">
            <div class="col-md-12 col-lg-9">
                <h1 class="mbr-section-title mbr-fonts-style mb-3 display-1"><strong>¡SUPER USUARIO!</strong></h1>
                ...
                <p class="mbr-text mbr-fonts-style display-5">Agrega nuevos administradores.</p>
